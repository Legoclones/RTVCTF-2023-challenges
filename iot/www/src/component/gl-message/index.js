    ...
    var Message = function Message() {
        ...
        switch (instance.type) {
            case "success":
                ...
                instance.duration = typeof instance.duration === 'number' ? instance.duration : 3000;
            ...
            default:
                ...
                instance.iconFont = "fa fa-spinner fa-pulse";
                instance.duration = typeof instance.duration === 'number' ? instance.duration : 5000;
                instance.msg = instance.msg ? instance.msg : "Your operation is in progress.";
        }
