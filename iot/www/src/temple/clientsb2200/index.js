...
define(["text!temple/clientsb2200/index.html", "css!temple/clientsb2200/index.css", "component/gl-toggle-btn/index", "component/gl-btn/index", "vue", "component/gl-tooltip/index", "component/modal/modal", "component/gl-input/index", "component/gl-toggle-btn/index"], function (stpl, css, gl_toggle, gl_btn, Vue, gl_tooltip, gl_modal, gl_input, gl_toggle_btn) {
    var vueComponent = Vue.extend({
        ...
        computed: {
            ...
            meshjudge: function meshjudge() {
                return this.router.mode == 'mesh' ? true : false;
            }
        },
        methods: {
